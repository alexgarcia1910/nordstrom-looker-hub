        ...
        <div className="mb-6 flex justify-end gap-4">
          <Card className="p-4 flex items-center gap-3 hover:shadow-md transition-shadow cursor-pointer max-w-sm">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Domain-specific setup guides and onboarding resources.</p>
            </div>
          </Card>
                ...
                filteredData.map((item) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge
                        variant="outline"
                        className={cn("text-xs", getEnvironmentBadgeColor(item.environment))}
                      >
