...
import { Home, Users, DollarSign, ShoppingBag, Store, Truck, Cpu, Menu, X, Settings, ChevronRight, Library, Bell, AlertCircle } from "lucide-react";
...
export const SidebarV5 = ({ selectedCategory, onCategorySelect, onAdminToggle, isAdminMode }: SidebarV5Props) => {
      ...
      >
        ...
        <nav className="px-3 space-y-1 flex-1">
          {categories.map((category) => {
            ...
            const isActive = location.pathname === "/v5" && selectedCategory === category.id;
        ...
        <div className="px-3 pb-4 mt-auto pt-4 space-y-1">
          <Button
            variant="ghost"
